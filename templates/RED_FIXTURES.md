...
Canonical fixture identity is schema-owned by `schemas/schema-authority-primitives.schema.json#/$defs/requiredRedFixtureId`; catalog shape is owned by `schemas/red-fixtures-catalog.schema.json`.
