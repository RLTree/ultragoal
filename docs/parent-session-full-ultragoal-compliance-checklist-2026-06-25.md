...
- [ ] `cargo test --offline` passes after topology repair.
  - Evidence: full offline suite was not rerun for the current source-local checkpoint. Current focused evidence is `cargo test --offline final_packet --lib --quiet` passing `10/10` and `cargo test --offline observe --lib --quiet` passing `13/13` for package digest `sha256:731ca8e3616de34ed2168cbff6443f17530f82cd0239369df90370adb06338ce`.
  - Candidate digest: `sha256:731ca8e3616de34ed2168cbff6443f17530f82cd0239369df90370adb06338ce`.
  - Status: focused source-local tests only; does not prove full-suite status, install/cache parity, final packet correctness, registry/reviewer exposure, readiness, release, completion, or `update_goal()` eligibility.
...
- [ ] Run `cargo test --offline`. Evidence: full offline suite was not rerun for package digest `sha256:731ca8e3616de34ed2168cbff6443f17530f82cd0239369df90370adb06338ce` in this checkpoint. Focused checks did pass: `cargo test --offline final_packet --lib --quiet` passed `10/10`, and `cargo test --offline observe --lib --quiet` passed `13/13`. Claim impact: focused source-local tests only; no full-suite, install/cache parity, final packet correctness, registry/reviewer exposure, readiness, release, completion, or `update_goal()` claim.
