...
- [x] Gate 6 evidence path: Current red fixture propagation proof is source-local and same-candidate for package digest `sha256:5f99a89c8d67659550ceed54f7e3ec3d332d810535010ea17d26d76af926c1f6`. Command `target/debug/ultragoal --root . source audit --receipt validation_artifacts/ultragoal-audit/validator-receipt.json --red-report validation_artifacts/ultragoal-audit/red-fixture-report.json` exited `0`; red report `validation_artifacts/ultragoal-audit/red-fixture-report.json = sha256:21cda526dc23a0c89482303557764ac012b3a819e8379f2a6940a7328dc3bf67` records `status = pass`, `total = 1238`, `failed = 0`, generated at `2026-06-29T10:56:10Z`. Claim impact: proves current red report only; full Gate 6 and all readiness/release/final-packet/registry/update_goal claims remain unchecked.
...
- [x] Full source audit with red fixture report passes after topology repair.
  ...
  - Receipt: `validation_artifacts/ultragoal-audit/validator-receipt.json = sha256:18b69094e255b2e39f2e572f6a2214179e73b64634dff1ca21e40962d21b2483`, run id `ultragoal-audit-2026-06-29T10:54:13Z`, `status = pass`, `checks = 150/150`.
  - Candidate digest: `sha256:5f99a89c8d67659550ceed54f7e3ec3d332d810535010ea17d26d76af926c1f6`.
  - Red report: `validation_artifacts/ultragoal-audit/red-fixture-report.json = sha256:21cda526dc23a0c89482303557764ac012b3a819e8379f2a6940a7328dc3bf67`, `status = pass`, `1238/1238`.
...
- [x] Evidence path: Current package digest is `sha256:5f99a89c8d67659550ceed54f7e3ec3d332d810535010ea17d26d76af926c1f6` from `target/debug/ultragoal --root . package digest`. Product/Fit/Journey, exact coverage, Rust/GC, standards-gardener, Gate 92 source-local stack/query/prove, fail-closed registry, fail-closed final-packet proof, fail-closed transactional finalization, fail-closed CLI self-law, fail-closed update-goal eligibility, source audit, red report, detached review-target, and detached candidate archive receipts are current for this digest. Claim impact: source-local and detached-anchor evidence only; final-packet correctness, transactional finalization green proof, CLI self-law green proof, update_goal eligibility, install/cache parity, registry/reviewer exposure, readiness, release, completion claim, and `update_goal()` call remain unsupported.

## `update_goal()` Is Forbidden Until All Are True

- [ ] Status: in_progress
- [x] Current source audit passes.
  - Evidence: `validation_artifacts/ultragoal-audit/validator-receipt.json = sha256:18b69094e255b2e39f2e572f6a2214179e73b64634dff1ca21e40962d21b2483` targets package digest `sha256:5f99a89c8d67659550ceed54f7e3ec3d332d810535010ea17d26d76af926c1f6`, run id `ultragoal-audit-2026-06-29T10:54:13Z`, and records `status = pass`, `checks = 150/150`, `failed = []`. Command: `target/debug/ultragoal --root . source audit --receipt validation_artifacts/ultragoal-audit/validator-receipt.json --red-report validation_artifacts/ultragoal-audit/red-fixture-report.json` exited `0`. Claim impact: current source audit only; not readiness, release, final-packet correctness, registry/reviewer exposure, completion, or `update_goal()` eligibility.
- [x] Current red fixture report passes with all fixtures failing for intended reasons.
  - Evidence: `validation_artifacts/ultragoal-audit/red-fixture-report.json = sha256:21cda526dc23a0c89482303557764ac012b3a819e8379f2a6940a7328dc3bf67` targets package digest `sha256:5f99a89c8d67659550ceed54f7e3ec3d332d810535010ea17d26d76af926c1f6` and records `status = pass`, `total = 1238`, `failed = 0`. Claim impact: current red fixture report only; not readiness, release, final-packet correctness, registry/reviewer exposure, completion, or `update_goal()` eligibility.
