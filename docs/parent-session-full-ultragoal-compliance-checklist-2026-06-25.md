...
- [ ] Run full source audit with receipt and red fixture report. Evidence: Status: stale due to source change. Live source-local package digest is `sha256:9b9267b77b168ea40307d86d12d9af826579610407f2103d17422eb58a1d7cec`; source audit and red fixture report have not been rebound for this checkpoint. Claim impact: no current source-audit or red-report pass claim; no registry/reviewer exposure, final-packet correctness, readiness, release, completion, or `update_goal()` claim.
