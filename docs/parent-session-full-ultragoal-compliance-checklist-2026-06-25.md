...
- [ ] Gate 3 evidence path: Source-local Product/Fit/Journey receipts were minted for current digest `sha256:b6c7cee8bf6714682cf1ea4e277f0820b1b7e4e19ac719030100e54243a867cb` by `target/debug/ultragoal --root . product prove-fitness --receipt-dir validation_artifacts/harness` exiting `0`. Evidence digests: `validation_artifacts/harness/fit-repo-receipt.json = sha256:b022114b0d585efa61ea64eabddd68cab829273b3403c531364ed86f0f47f026`; `validation_artifacts/harness/product-fitness-receipt.json = sha256:3949131734bc55e32c2d39260f384813c4d1b6e14136bc237b4b6d8a8b848fe9`; `validation_artifacts/harness/plugin-product-journey-receipt.json = sha256:7e82a0ede2f7530b02ddc4c94f3e9dde48a52321688b77395097a5a0272c4134`. Gate remains unchecked until every Gate 3 contract sub-requirement is verified by the current source audit/red report, not merely receipt creation.
...
- [x] Gate 5 evidence path: Current exact coverage proof passed for package digest `sha256:f418969dd89ea21ef681f42f90c79f628125c248b55843660c9b8c1fc4cb3133`. Command `bash scripts/check-coverage-full /Users/terrynoblin/Projects/harness-ultragoal-plugin-proposal` exited `0` after 434 library tests and 1 CLI integration test passed under llvm-cov. Typed receipt `validation_artifacts/coverage/coverage-receipt.json = sha256:adbccbbacb0c28306c5ca5a816506c5d726d6141e520d90e2dd44e32e4ebee3d` has `target_revision.value = sha256:f418969dd89ea21ef681f42f90c79f628125c248b55843660c9b8c1fc4cb3133`, `coverage.percent = 100`, `uncovered_records = []`, `changed_files_digest = sha256:0bf0e730f3760a173f0d9d8fdc5105d35dd1e67188909b41c57819db543eebd4`, and `generated_at = 2026-06-28T19:05:31Z`; supporting artifacts are `validation_artifacts/coverage/llvm-cov-full.json = sha256:e92cc958bdb1b5b346848499f91a160a6e4510fe82772810227a9ecc05609ade` and `validation_artifacts/coverage/missing-lines.txt = sha256:c9779e6d2ef3d2280b6805962b6a5a3a134ab33f28d6d3d7686392203864351d`. Gate remains in progress until current source audit validates coverage coupling, coverage-substitute rejection, and the rest of Gate 5.
...
- [ ] Gate 6 evidence path: Latest red fixture report is now stale for the current source digest. Existing report `validation_artifacts/ultragoal-audit/red-fixture-report.json = sha256:967f6d6b9983b1b18c2184a43b6057b6327fecc9667ea2e0c51775c63d6b7d13` targeted prior digest `sha256:f1fde89af147b4cf1b2a8d816065f7a52151a4989f0845e763863925a49c9595` with `status = pass` and `1213/1213`; current package digest is `sha256:b6c7cee8bf6714682cf1ea4e277f0820b1b7e4e19ac719030100e54243a867cb`. Gate remains unchecked until the red report is regenerated for the current digest and paired with a current source audit.
...
- [ ] CLI performance, latency, speed, and iteration fitness are first-class Harness Ultragoal laws, not polish, and the CLI cannot support completion, review readiness, package readiness, product readiness, release readiness, registry readiness, app readiness, or update_goal eligibility when performance proof is missing or failing.
  ...
  - Status: stale for current digest `sha256:b6c7cee8bf6714682cf1ea4e277f0820b1b7e4e19ac719030100e54243a867cb`; rerun pending.
...
- [ ] CLI performance law is represented in agent-standards enforcement rows, source-obligation rows, foundational trace entries, schema catalog, validator checks, red fixtures, green fixtures, tamper/stale-cache fixtures where applicable, receipt requirements, package inventory, claim-ceiling guards, validation evidence, final packet, and update_goal eligibility.
  - Evidence: Implemented source surfaces include standards row, source-obligation row, foundational trace entry, validator check id, audit module, schema catalog entry, performance receipt schema, valid mandatory-law fixture, 22 red fixtures, package inventory entries, plugin cohesion manifest entries, and claim-ceiling blocking fields in the performance receipt. Current source audit check `cli-performance-latency-speed-iteration-fitness` passes and current red fixture report passes `1213/1213`. Final packet/update_goal still remain fail-closed because other proof graph dependencies are not green.
  - CLI command: `target/debug/ultragoal --root . performance prove --receipt validation_artifacts/cli/performance-receipt.json`
  - Receipt: `validation_artifacts/cli/performance-receipt.json`
  - Candidate digest: `sha256:f1fde89af147b4cf1b2a8d816065f7a52151a4989f0845e763863925a49c9595`
  - Status: stale for current digest `sha256:b6c7cee8bf6714682cf1ea4e277f0820b1b7e4e19ac719030100e54243a867cb`; rerun pending.
...
- [x] Coverage proof remains exactly 100 percent with `uncovered_records = []` after topology repair.
  - Evidence: `validation_artifacts/coverage/coverage-receipt.json = sha256:adbccbbacb0c28306c5ca5a816506c5d726d6141e520d90e2dd44e32e4ebee3d`; `validation_artifacts/coverage/llvm-cov-full.json = sha256:e92cc958bdb1b5b346848499f91a160a6e4510fe82772810227a9ecc05609ade`; `validation_artifacts/coverage/missing-lines.txt = sha256:c9779e6d2ef3d2280b6805962b6a5a3a134ab33f28d6d3d7686392203864351d`.
  ...
  - Candidate digest: `sha256:f418969dd89ea21ef681f42f90c79f628125c248b55843660c9b8c1fc4cb3133`.
  - Status:
...
- [x] `cargo llvm-cov` is the canonical Rust coverage proof path for declared Rust scope, with exact 100 percent coverage, `uncovered_records = []`, candidate/source/toolchain binding, and anti-gaming checks.
  - Evidence: `validation_artifacts/coverage/coverage-receipt.json = sha256:adbccbbacb0c28306c5ca5a816506c5d726d6141e520d90e2dd44e32e4ebee3d`; `validation_artifacts/coverage/llvm-cov-full.json = sha256:e92cc958bdb1b5b346848499f91a160a6e4510fe82772810227a9ecc05609ade`.
  - CLI command: `bash scripts/check-coverage-full /Users/terrynoblin/Projects/harness-ultragoal-plugin-proposal` exited `0`.
  - Receipt: `target_revision.value = sha256:f418969dd89ea21ef681f42f90c79f628125c248b55843660c9b8c1fc4cb3133`, `source_tree_digest = sha256:89b7323fc4abd35d60a8c2795d75960c59fbd2c6c14fc78be8d0c406b1e63801`, `coverage.percent = 100`, `uncovered_records = []`.
  - Candidate digest: `sha256:f418969dd89ea21ef681f42f90c79f628125c248b55843660c9b8c1fc4cb3133`.
  - Status:
...
- [ ] Evidence path: Current source-local validation evidence is bound to package digest `sha256:33b09266f53ac3f0bd37ae8c73ec258a0f0be23bf9f33278d3f290a8fa2deed0`. `cargo fmt --check` exited `0`; `cargo test --offline --quiet` exited `0` with 456 library tests, 0 binary unit tests, 1 CLI integration test, and doc-tests passing; filtered line-cap scan over `validator/src/**/*.rs` emitted no over-250 files. `target/debug/ultragoal --root . source audit --receipt validation_artifacts/ultragoal-audit/validator-receipt.json --red-report validation_artifacts/ultragoal-audit/red-fixture-report.json` exited `0` at run id `ultragoal-audit-2026-06-29T00:07:21Z`; `validation_artifacts/ultragoal-audit/validator-receipt.json = sha256:f3ffacd3cbc333c95c0744624a6d6c047866b20f0984730b38d833db1fc352a8`, status `pass`, 149/149 checks passing. Red report `validation_artifacts/ultragoal-audit/red-fixture-report.json = sha256:5e5db97f6265eaddea9e7a3cbeca5d31756d40538830fbbe2f23b013d72cbd55`, status `pass`, 1213/1213 fixtures passing intended failures. Coverage receipt `validation_artifacts/coverage/coverage-receipt.json = sha256:a6c0be328fc752ada2aa1db579c394c22fc47df0bd05c78cb26c5566b8f6b293` is current with `coverage.percent = 100` and `uncovered_records = []`. Product/Fit/Journey, Rust DevX, GC, standards-gardener, and CLI performance receipts are current for this digest; final-packet proof, live registry/reviewer exposure, transactional finalization, CLI self-law, and update_goal eligibility remain same-candidate fail-closed. Outside-root scratch audit `/private/tmp/harness-ultragoal-audit-scratch/validator-receipt.json` also exited `0` after the latest final-packet/control receipt refresh, proving the current proof graph without adding package artifacts. No install/cache refresh, version bump, final packet, readiness/release/completion claim, or `update_goal()` call is permitted.
...
- [ ] Evidence path: Current stop-condition evidence is still mixed and blocks `update_goal()`. Current package digest is `sha256:33b09266f53ac3f0bd37ae8c73ec258a0f0be23bf9f33278d3f290a8fa2deed0`. Current source audit `validation_artifacts/ultragoal-audit/validator-receipt.json = sha256:f3ffacd3cbc333c95c0744624a6d6c047866b20f0984730b38d833db1fc352a8` has `status = pass`, run id `ultragoal-audit-2026-06-29T00:07:21Z`, and 149/149 checks passing. Current red fixture report `validation_artifacts/ultragoal-audit/red-fixture-report.json = sha256:5e5db97f6265eaddea9e7a3cbeca5d31756d40538830fbbe2f23b013d72cbd55` has `status = pass`, target digest `sha256:33b09266f53ac3f0bd37ae8c73ec258a0f0be23bf9f33278d3f290a8fa2deed0`, generated_at `2026-06-29T00:09:11Z`, and 1213/1213 red fixtures passing intended failures. Final-packet proof `validation_artifacts/review/final-packet-proof.json = sha256:482d7b65f7e4d64650e45dbf760019823fd8d96ea02737f02bd6e0fcce471eac` remains `status = fail`, `claim_ceiling = withheld_or_blocked`; registry probe `validation_artifacts/cli/registry-probe-receipt.json = sha256:26bbf9b74c1963599e6877f3ffaa614db5bb7861c20a6f9a0f370048be59aee4` remains fail-closed; transactional finalization `validation_artifacts/cli/transactional-finalization-receipt.json = sha256:400823e051073d186e2cc75b779a63c94e7021f1e74a01e41fed10620529e061`, CLI self-law `validation_artifacts/cli/self-law-receipt.json = sha256:c5e15a1008a1d03212340c3b99770c9bb0cfd24574f2cfe9278b9fcc60759a9c`, and update_goal eligibility `validation_artifacts/cli/update-goal-eligibility.json = sha256:91caf17fb580847adaaba29fc5260add6e341d7a968c572ed8f7be65f6f8932a` remain same-candidate fail-closed. No install/cache refresh, version bump, final packet, readiness/release/completion claim, or `update_goal()` call is permitted.
- [ ] Gate 90 evidence path: Current stop-condition evidence is partially implemented but not complete. Physical topology repair has removed the side-audit baseline violations: `find validator/src -maxdepth 1 -type f \( -name 'internal_*.rs' -o -name 'internal_coverage*.rs' -o -name 'iinternal_*.rs' \) -print | sort` emitted no rows; `docs/namespace-law-exceptions.json` is absent; `find validator/src -type f -name '*.rs' -exec wc -l {} + | awk '$2 != "total" && $1 > 250 { print }'` emitted no over-cap files. Source audit and red report pass for `sha256:33b09266f53ac3f0bd37ae8c73ec258a0f0be23bf9f33278d3f290a8fa2deed0`. Gate 90 remains unchecked until the required confidence calculation, full namespace red/green/tamper proof accounting, package/review projection, and all dependent stop conditions are complete.
- [ ] Gate 91 evidence path: Current stop-condition evidence is partially implemented but not complete. Same-candidate Rust DevX receipts pass for toolchain, fast, standard, release, clean-proof, watch, memory, dependency, coverage, and workspace-topology under `validation_artifacts/rust/`; GC plan/dry-run/apply/verify receipts pass under `validation_artifacts/gc/`; source audit and red report pass for `sha256:33b09266f53ac3f0bd37ae8c73ec258a0f0be23bf9f33278d3f290a8fa2deed0`. Gate 91 remains unchecked because cache/no-cache honesty, red/green/tamper completeness, confidence calculation, final packet, install/cache sync, and update_goal eligibility are not complete. No raw Cargo/tool output, watcher/editor state, hidden cache state, blind cleanup, or memory/resource prose can satisfy this stop condition.
