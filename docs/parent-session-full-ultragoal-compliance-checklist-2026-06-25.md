...
- [ ] Evidence path: Status: in progress. Latest committed source-local receipts for digest `sha256:fd5f598f0a70a1fc4128bf29eae3f73ced9d5ec0bdce3a8b0a144942549b3a90` are stale due to the package-check scheduler source change. Current implementation evidence is limited to focused scheduler/package/audit tests, `cargo fmt --check`, and a raw line-cap scan. Phase-boundary digest, coverage, Product/Fit/Journey, Rust/GC, standards-gardener, source audit, red report, final-packet, registry/app/install/cache, self-law, and update-goal receipts are pending. Claim impact: source-local implementation progress only; no final-packet correctness, CLI self-law green proof, update_goal eligibility, registry/reviewer exposure, readiness, release, completion claim, install/cache parity, or `update_goal()` call.
...
- [ ] Plugin self-coverage is 100% with typed receipt and no uncovered records.
  - Evidence: Status: stale due to source change. The last exact coverage receipt targets `sha256:fd5f598f0a70a1fc4128bf29eae3f73ced9d5ec0bdce3a8b0a144942549b3a90`; package-check scheduler source changed after that proof. Claim impact: no current exact-coverage claim until the next phase-boundary coverage run.
...
- [ ] Product Fitness receipt is current and substitution failures are enforced. Evidence: Status: stale due to source change. Product/Fit/Journey receipts were rebound to `sha256:fd5f598f0a70a1fc4128bf29eae3f73ced9d5ec0bdce3a8b0a144942549b3a90`, but package-check scheduler source changed after that proof. Claim impact: no current Product/Fit/Journey claim until the next phase-boundary rebind.
