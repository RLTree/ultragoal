...
- [x] Gate 6 evidence path: Current red fixture propagation proof is source-local and same-candidate for package digest `sha256:73ff40a280dda0a5029471c3fd90bcbf3e97f4dfb39983cc69461025d9c75f9b`. Command `target/debug/ultragoal --root . source audit --receipt validation_artifacts/ultragoal-audit/validator-receipt.json --red-report validation_artifacts/ultragoal-audit/red-fixture-report.json` exited `0`; red report `validation_artifacts/ultragoal-audit/red-fixture-report.json = sha256:210a5b7201d91b4976e495701c9ac92e71b746d47e51b96a90f146044a3752c1` records `status = pass`, `total = 1238`, `failed = 0`, generated at `2026-06-29T09:40:54Z`. Claim impact: proves current red report only; full Gate 6 and all readiness/release/final-packet/registry/update_goal claims remain unchecked.
...
- [x] Full source audit with red fixture report passes after topology repair.
  ...
  - Receipt: `validation_artifacts/ultragoal-audit/validator-receipt.json = sha256:a9ee2dbd45bfcbc2e4ae5d3857a46a5a210b89470cd265e6be0c5bd06ce99386`, run id `ultragoal-audit-2026-06-29T09:38:59Z`, `status = pass`, `checks = 150/150`.
  - Candidate digest: `sha256:73ff40a280dda0a5029471c3fd90bcbf3e97f4dfb39983cc69461025d9c75f9b`.
  - Red report: `validation_artifacts/ultragoal-audit/red-fixture-report.json = sha256:210a5b7201d91b4976e495701c9ac92e71b746d47e51b96a90f146044a3752c1`, `status = pass`, `1238/1238`.
...
- [x] Run full source audit with receipt and red fixture report. Evidence: `target/debug/ultragoal --root . source audit --receipt validation_artifacts/ultragoal-audit/validator-receipt.json --red-report validation_artifacts/ultragoal-audit/red-fixture-report.json` exited `0` for package digest `sha256:73ff40a280dda0a5029471c3fd90bcbf3e97f4dfb39983cc69461025d9c75f9b`; source receipt `validation_artifacts/ultragoal-audit/validator-receipt.json = sha256:a9ee2dbd45bfcbc2e4ae5d3857a46a5a210b89470cd265e6be0c5bd06ce99386` records `status = pass`, `150/150`; red report `validation_artifacts/ultragoal-audit/red-fixture-report.json = sha256:210a5b7201d91b4976e495701c9ac92e71b746d47e51b96a90f146044a3752c1` records `status = pass`, `1238/1238`. Claim impact: source-local audit/red proof only; no install/cache parity, registry/reviewer exposure, final-packet correctness, readiness, release, completion, or update_goal claim.
