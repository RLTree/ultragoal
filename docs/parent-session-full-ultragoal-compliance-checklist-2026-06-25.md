...
- [ ] CT-001 - Not allowed: source audit pass coexists with transition-only CLI control-plane eligibility.
...
- [ ] CT-002 - Not allowed: CLI performance law can remain failing/stale while the source audit passes.
...
- [ ] CT-003 - Not allowed: active registry/reviewer exposure proof remains stale or underspecified while source/install/cache evidence is passing.
...
- [ ] CT-004 - Not allowed: stale final packet evidence cannot support the current candidate.
...
- [ ] CT-005 - Not allowed: source/install/cache pass must not be treated as full Harness Ultragoal compliance.
