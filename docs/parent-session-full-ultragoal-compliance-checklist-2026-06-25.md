...
- [ ] Gate 4 evidence path: Source now resolves to `sha256:904d38ecc6afc01e02418f836c9985043ccf32a5cb2a97dd863885f9aa403be4` by `target/debug/ultragoal --root . package digest`. Install/cache refresh remains forbidden at this source-local phase; install/cache audit receipts are fail-closed observations only, not parity proof. Claim impact: no current install/cache/app-registry/reviewer/readiness claim is supported.
