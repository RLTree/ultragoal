...
- [ ] Default budget thresholds are enforced: `hot_edit_check` cold p95 <= 5 seconds; `focused` cold p95 <= 15 seconds and warm p95 <= 5 seconds; `standard_source_local` cold p95 <= 30 seconds and warm p95 <= 10 seconds; `strict_local` p95 target <= 60 seconds on declared baseline; `strict_fixtures` full red/green/stale/wrong-surface/wrong-digest/tamper/substitute/miswire suite p95 target <= 60 seconds; `strict_coverage` exact coverage p95 target <= 60 seconds and hard ceiling <= 180 seconds; `strict_final` source-local p95 target <= 60 seconds and hard ceiling <= 180 seconds; `external_live` has typed bounded timeout/retry/backoff budgets, no unbounded execution, and claim blocking on failure.
  - Evidence: Partial current implementation work is adding source-audit scheduler/timing evidence for package schema checks and receipt speed budgets, but the full budget enum, red/green/tamper fixture suite, performance receipts, and source audit evidence have not been regenerated for the current digest.
  - CLI command: Focused tests only so far: `cargo test --offline scheduler --lib --quiet`, `cargo test --offline package_checks --lib --quiet`, `cargo test --offline speed_budget --lib --quiet`, `cargo test --offline validator_receipt --lib --quiet`, `cargo test --offline source_audit_run_writes_observability_through_cli_boundary --lib --quiet`, and `cargo test --offline source_audit_parser_accepts_bounded_jobs --lib --quiet`.
  - Receipt: Not current; no Gate 89.20 completion receipt is supported by this row.
  - Candidate digest: current live implementation digest is `sha256:c7f5889cfd3d2ef53366162aa0a634bcc2c56316264a02fe94b890f9b986aa8a`; this unchecked row has no current performance receipt.
...
- [ ] Mandatory research-source registry includes the original nine observability/harness-engineering sources, the OpenAI agent-improvement loop cookbook, and the OpenAI self-improving tax-agent article with stable ids, URLs, source digests, retrieved/source-card evidence, affected canonical law ids, setup/retrofit implications, tool/package implications, privacy implications, and claim-ceiling impact.
  ...
  - Status: unchecked after current source-local edits; prior registry evidence targets `sha256:f67bcb8c9ede3ef968c6e372d7f1092a5cc55a9a054edc1faa0d7b8777860383`, while the current live package digest is `sha256:c7f5889cfd3d2ef53366162aa0a634bcc2c56316264a02fe94b890f9b986aa8a`. Claim impact: source-local research registry authority only; no review readiness, package readiness, release readiness, final-packet correctness, registry/reviewer exposure, completion, or `update_goal()` claim.
...
- [ ] Evidence path: Current source-local implementation digest is `sha256:c7f5889cfd3d2ef53366162aa0a634bcc2c56316264a02fe94b890f9b986aa8a` from `target/debug/ultragoal --root . package digest` and `validation_artifacts/observability/package-digest.json`. Current stabilization evidence is limited to package digest, `cargo build --offline`, `cargo fmt --check`, full library tests, focused mandatory-law/independent-verification/scheduler/package-check/namespace tests, and a raw line-cap scan. Coverage, Product/Fit/Journey, Rust/GC, standards-gardener, source audit, red report, final-packet, registry/app/install/cache, self-law, and update-goal receipts are stale or not rerun for this digest. Claim impact: source-local evidence only; no final-packet correctness, transactional finalization green proof, CLI self-law green proof, update_goal eligibility, registry/reviewer exposure, readiness, release, completion claim, install/cache parity, or `update_goal()` call.

## `update_goal()` Is Forbidden Until All Are True

- [ ] Status: in_progress
- [ ] Current source audit passes.
  - Evidence: unchecked. Latest persisted source audit is stale relative to live implementation digest `sha256:c7f5889cfd3d2ef53366162aa0a634bcc2c56316264a02fe94b890f9b986aa8a`; `validation_artifacts/ultragoal-audit/validator-receipt.json` targets `sha256:1bf81589063cd172cf8a896594ccc2c75f53924b04dd90cb7c2596fb65cd42f5` and status `fail`. Claim impact: no current source-audit pass claim; readiness, release, completion, final-packet correctness, and `update_goal()` remain blocked.
- [ ] Current red fixture report passes with all fixtures failing for intended reasons.
  - Evidence: unchecked. Latest persisted red fixture report is stale relative to live implementation digest `sha256:c7f5889cfd3d2ef53366162aa0a634bcc2c56316264a02fe94b890f9b986aa8a`; `validation_artifacts/ultragoal-audit/red-fixture-report.json` targets `sha256:1bf81589063cd172cf8a896594ccc2c75f53924b04dd90cb7c2596fb65cd42f5` and status `fail`, so it is not current proof. Claim impact: no current red-fixture pass claim, no source-audit pass, readiness, release, completion, final-packet correctness, or `update_goal()` claim.
...
- [ ] Plugin self-coverage is 100% with typed receipt and no uncovered records.
  - Evidence: unchecked. Latest persisted coverage receipt targets `sha256:84c0e8f27dabfa79804b516d9606670ba235b9d994b5636f53f230d21be08add`, not live implementation digest `sha256:c7f5889cfd3d2ef53366162aa0a634bcc2c56316264a02fe94b890f9b986aa8a`. Exact coverage must be rerun before this row can support a current claim. Claim impact: no current exact-coverage claim, no readiness/release/final-packet/registry/reviewer/completion or `update_goal()` claim.
...
- [x] Line-cap adherence is enforced. Evidence: `find validator/src -name '*.rs' -exec wc -l {} + | awk '$2 != "total" && $1 > 250 { print }'` emitted no rows, `cargo fmt --check` exited `0`, focused namespace test `cargo test --offline namespace_source_topology_is_selective_about_prefixes_and_generic_leaves --lib --quiet` passed 1/1, and full library tests passed 567/567 for current live implementation digest `sha256:c7f5889cfd3d2ef53366162aa0a634bcc2c56316264a02fe94b890f9b986aa8a`. Claim impact: source-local line-cap/source-topology evidence only; no readiness/release/completion/update_goal claim.
...
- [ ] Evidence path: Current stop-condition evidence is incomplete for live implementation digest `sha256:c7f5889cfd3d2ef53366162aa0a634bcc2c56316264a02fe94b890f9b986aa8a`. Current evidence is limited to package digest, Rust build/fmt/full-library tests, focused mandatory-law/independent-verification/scheduler/package-check/namespace tests, and raw line-cap scan. Product/Fit/Journey, coverage, Rust DevX/GC/performance receipts, standards-gardener, source audit, red report, final-packet, control-plane, registry, install/cache, review-target, and candidate-archive receipts from prior digests are stale until rerun. No version bump, final packet correctness, active registry/reviewer exposure, readiness/release/completion claim, or `update_goal()` call is permitted.
- [ ] Gate 90 evidence path: Physical source topology repair is source-local for live implementation digest `sha256:c7f5889cfd3d2ef53366162aa0a634bcc2c56316264a02fe94b890f9b986aa8a`: prefix-encoded moved modules include `validator/src/audit/package/run/mod.rs`, `validator/src/scheduler/mod.rs`, and `validator/src/self_tests/receipts/validator/{mod.rs,boundaries.rs,generated.rs}`; focused namespace test passed and line-cap scan emitted no rows. Prior source-audit/coverage/red-report evidence is stale relative to this checkpoint; confidence calculation and dependent stop conditions remain unchecked.
- [ ] Gate 91 evidence path: Current stop-condition evidence is incomplete for live implementation digest `sha256:c7f5889cfd3d2ef53366162aa0a634bcc2c56316264a02fe94b890f9b986aa8a`. Prior Rust DevX/GC/performance receipts are stale until separately rebound; final packet correctness, app-registry/reviewer proof, update_goal eligibility, and confidence calculation remain unchecked. No raw Cargo/tool output, watcher/editor state, hidden cache state, blind cleanup, or memory/resource prose can satisfy this stop condition.
...
- [ ] Gate 92 evidence path: In progress, source-local only. Latest live implementation digest is `sha256:c7f5889cfd3d2ef53366162aa0a634bcc2c56316264a02fe94b890f9b986aa8a`; prior Gate 92 stack/query/prove/explain receipts target older digests and are stale until rebound. The fitting inventory still blocks full Gate 92 because not every command, plugin surface, operating-loop stage, or signal row is fitted with same-candidate query proof. Claim impact: no final packet correctness, review readiness, package readiness, release readiness, completion, `update_goal()` eligibility, registry exposure, reviewer exposure, or full Gate 92 proof.
