...
- [ ] CLI performance, latency, speed, and iteration fitness are first-class Harness Ultragoal laws, not polish, and the CLI cannot support completion, review readiness, package readiness, product readiness, release readiness, registry readiness, app readiness, or update_goal eligibility when performance proof is missing or failing.
  - Evidence: Partial source implementation and focused tests are current for live package digest `sha256:fd5f598f0a70a1fc4128bf29eae3f73ced9d5ec0bdce3a8b0a144942549b3a90`; the persisted performance receipt is stale because it targets `sha256:e2e422756f4404c5e0d3f363d1172c4ee5aba891cd1aff2a02d6c8fb4a9abd41`. Source surfaces include `validator/src/cli/performance/proof.rs`, `validator/src/cli/performance/receipt.rs`, `validator/src/cli/performance/types.rs`, `validator/src/scheduler/mod.rs`, and focused tests under `validator/src/self_tests/cli/performance/`. This supports no current performance receipt claim.
  - CLI command: `cargo test --offline performance --lib --quiet` exited `0`; `target/debug/ultragoal --root . performance prove --receipt validation_artifacts/cli/performance-receipt.json` has not been rerun for `sha256:fd5f598f0a70a1fc4128bf29eae3f73ced9d5ec0bdce3a8b0a144942549b3a90`.
  - Receipt: stale `validation_artifacts/cli/performance-receipt.json`.
  - Candidate digest: live `sha256:fd5f598f0a70a1fc4128bf29eae3f73ced9d5ec0bdce3a8b0a144942549b3a90`; stale receipt target `sha256:e2e422756f4404c5e0d3f363d1172c4ee5aba891cd1aff2a02d6c8fb4a9abd41`.
  - Status: partial source-local implementation only; broader Gate 89.20, readiness, completion, final-packet correctness, and `update_goal()` remain unchecked.
...
- [ ] CLI defines hard typed performance budgets for `instant`, `interactive`, `focused`, `repair_loop`, `strict_local`, `strict_fixtures`, `strict_coverage`, `strict_final`, and `external_live` command classes, with no absent, advisory, prose-only, or hidden budgets.
  ...
  - CLI command: focused performance and scheduler tests passed; performance receipt has not been regenerated for the live digest.
  - Receipt: stale `validation_artifacts/cli/performance-receipt.json`.
  - Candidate digest: live `sha256:fd5f598f0a70a1fc4128bf29eae3f73ced9d5ec0bdce3a8b0a144942549b3a90`; stale receipt target `sha256:e2e422756f4404c5e0d3f363d1172c4ee5aba891cd1aff2a02d6c8fb4a9abd41`.
  - Status: partial source-local typed-budget implementation only; broader Gate 89.20, readiness, completion, final-packet correctness, and `update_goal()` remain unchecked.
...
- [ ] Default budget thresholds are enforced: `hot_edit_check` cold p95 <= 5 seconds; `focused_repair` cold p95 <= 15 seconds and warm p95 <= 5 seconds; `standard_source_local` cold p95 <= 30 seconds and warm p95 <= 10 seconds; `strict_local` p95 target <= 60 seconds; `strict_fixtures` full red/green/stale/wrong-surface/wrong-digest/tamper/substitute/miswire suite p95 target <= 60 seconds; `strict_coverage` exact coverage p95 target <= 60 seconds and hard ceiling <= 180 seconds; `strict_final` source-local p95 target <= 60 seconds and hard ceiling <= 180 seconds; `external_live` has typed bounded timeout/retry/backoff budgets, no unbounded execution, and claim blocking on failure.
  ...
  - Candidate digest: live implementation digest is `sha256:fd5f598f0a70a1fc4128bf29eae3f73ced9d5ec0bdce3a8b0a144942549b3a90`; stale performance receipt `validation_artifacts/cli/performance-receipt.json` targets `sha256:e2e422756f4404c5e0d3f363d1172c4ee5aba891cd1aff2a02d6c8fb4a9abd41`.
...
- [ ] CLI performance law is represented in agent-standards enforcement rows, source-obligation rows, foundational trace entries, schema catalog, validator checks, red fixtures, green fixtures, tamper/stale-cache fixtures where applicable, receipt requirements, package inventory, claim-ceiling guards, validation evidence, final packet, and update_goal eligibility.
  - Evidence: Implemented source surfaces include standards row, source-obligation row, foundational trace entry, validator check id, audit module, schema catalog entry, performance receipt schema, valid mandatory-law fixture, red fixtures, package inventory entries, plugin cohesion manifest entries, and claim-ceiling blocking fields in the performance receipt. Current source edits added stricter default worker-count and resource-telemetry enforcement, but the performance receipt and source audit have not been regenerated for live package digest `sha256:fd5f598f0a70a1fc4128bf29eae3f73ced9d5ec0bdce3a8b0a144942549b3a90`. Final packet/update_goal remain fail-closed.
  - CLI command: focused performance, scheduler, package-check, final-packet, control-plane, and red-identity tests passed; performance proof command pending rerun.
  - Receipt: stale `validation_artifacts/cli/performance-receipt.json`.
  - Candidate digest: live `sha256:fd5f598f0a70a1fc4128bf29eae3f73ced9d5ec0bdce3a8b0a144942549b3a90`.
  - Status: partial source-local performance-law implementation only; broader Gate 89.20, readiness, completion, final-packet correctness, and `update_goal()` remain unchecked.
...
- [ ] Run CLI performance/latency/speed/iteration-fitness proof and red fixtures. Evidence: stale after current source edits. Live source package digest is `sha256:fd5f598f0a70a1fc4128bf29eae3f73ced9d5ec0bdce3a8b0a144942549b3a90`; current performance receipt targets older digest `sha256:e2e422756f4404c5e0d3f363d1172c4ee5aba891cd1aff2a02d6c8fb4a9abd41`, and current source audit/red report are stale/failing. Focused performance tests passed, but no current performance receipt supports this row. Claim impact: no current performance proof claim; no update_goal, readiness, release, final packet, registry/reviewer, or completion claim.
...
- [ ] Evidence path: Current source-local implementation digest is `sha256:fd5f598f0a70a1fc4128bf29eae3f73ced9d5ec0bdce3a8b0a144942549b3a90` from `target/debug/ultragoal --root . package digest` and `validation_artifacts/observability/package-digest.json`. Current stabilization evidence is limited to package digest, `cargo fmt --check`, `cargo test --offline --lib --quiet` with `570/570` passing, focused scheduler/package/performance/final-packet/control-plane/red-identity tests, `cargo build --offline --quiet`, and a raw line-cap scan. Coverage, Product/Fit/Journey, Rust/GC, performance receipt, standards-gardener, source audit, red report, final-packet, registry/app/install/cache, self-law, and update-goal receipts are stale or not rerun for this digest. Claim impact: source-local evidence only; no current performance proof, final-packet correctness, transactional finalization green proof, CLI self-law green proof, update_goal eligibility, registry/reviewer exposure, readiness, release, completion claim, install/cache parity, or `update_goal()` call.
...
- [ ] Plugin self-coverage is 100% with typed receipt and no uncovered records.
  - Evidence: stale after current source edits. Live source package digest is `sha256:fd5f598f0a70a1fc4128bf29eae3f73ced9d5ec0bdce3a8b0a144942549b3a90`; latest coverage receipt targets older digest `sha256:20f1637d41f593668d38620bb3452a258d30b1369d4a2c5a7f73a9d06153a756`. Claim impact: no current exact-coverage claim until coverage is rerun for the live digest; no readiness/release/final-packet/registry/reviewer/completion or `update_goal()` claim.
