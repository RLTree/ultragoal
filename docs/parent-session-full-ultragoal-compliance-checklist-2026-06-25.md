...
- [x] Gate 5 evidence path: Exact coverage proof is current for package digest `sha256:20f1637d41f593668d38620bb3452a258d30b1369d4a2c5a7f73a9d06153a756`. Command `bash .harness/run-coverage.sh` exited `0`; receipt `validation_artifacts/coverage/coverage-receipt.json = sha256:dffd49b4c0ffca8ad4eca5b9b0da2ec85fe54cd6beba5a26e2e697f539e19c54` records `coverage.percent = 100`, `uncovered_records = []`, `claim_ceiling = supports_complete_coverage_claim`, source tree digest `sha256:74761da2b875c99a944265d3db6a12fdd42867a2fbfc6e2f7b33adbbb60b78f1`, changed-files digest `sha256:8e1fcf2b048517f8341899a5c916b95558359a2829beb22755227ac8344e679d`, and coverage manifest digest `sha256:a4e99908d27b622a14a7c1a9b3452b7eb9b78ef0ec7d1119210eef350beecd3a`. Claim impact: source-local exact coverage only; no readiness, release, final packet, registry/reviewer exposure, completion, or `update_goal()` claim.
...
- [x] Default budget thresholds are enforced: `hot_edit_check` cold p95 <= 5 seconds; `focused_repair` cold p95 <= 15 seconds and warm p95 <= 5 seconds; `standard_source_local` cold p95 <= 30 seconds and warm p95 <= 10 seconds; `strict_local` p95 target <= 60 seconds; `strict_fixtures` full red/green/stale/wrong-surface/wrong-digest/tamper/substitute/miswire suite p95 target <= 60 seconds; `strict_coverage` exact coverage p95 target <= 60 seconds and hard ceiling <= 180 seconds; `strict_final` source-local p95 target <= 60 seconds and hard ceiling <= 180 seconds; `external_live` has typed bounded timeout/retry/backoff budgets, no unbounded execution, and claim blocking on failure.
  ...
  - Candidate digest: current live implementation digest is `sha256:e2e422756f4404c5e0d3f363d1172c4ee5aba891cd1aff2a02d6c8fb4a9abd41`; current performance receipt `validation_artifacts/cli/performance-receipt.json` targets this digest, status `pass`, class `strict_local`, target `60000`, hard ceiling `180000`, wall clock `1395`.
...
- [ ] Coverage proof remains exactly 100 percent with `uncovered_records = []` after topology repair.
  ...
  - Command: `bash .harness/run-coverage.sh` exited `0`.
...
- [ ] `cargo llvm-cov` is the canonical Rust coverage proof path for declared Rust scope, with exact 100 percent coverage, `uncovered_records = []`, candidate/source/toolchain binding, and anti-gaming checks.
  ...
  - CLI command: `bash .harness/run-coverage.sh` exited `0`.
...
- [x] Run coverage command proving 100%. Evidence: `bash .harness/run-coverage.sh` exited `0` for package digest `sha256:20f1637d41f593668d38620bb3452a258d30b1369d4a2c5a7f73a9d06153a756`; receipt `validation_artifacts/coverage/coverage-receipt.json = sha256:dffd49b4c0ffca8ad4eca5b9b0da2ec85fe54cd6beba5a26e2e697f539e19c54` records `coverage.percent = 100`, `uncovered_records = []`, `source_tree_digest = sha256:74761da2b875c99a944265d3db6a12fdd42867a2fbfc6e2f7b33adbbb60b78f1`, `changed_files_digest = sha256:8e1fcf2b048517f8341899a5c916b95558359a2829beb22755227ac8344e679d`, and `claim_ceiling = supports_complete_coverage_claim`. Claim impact: source-local exact coverage only; no readiness/release/completion/final-packet/registry/update_goal claim.
...
- [ ] Evidence path: Current source-local implementation digest is `sha256:e2e422756f4404c5e0d3f363d1172c4ee5aba891cd1aff2a02d6c8fb4a9abd41` from `target/debug/ultragoal --root . package digest` and `validation_artifacts/observability/package-digest.json`. Current stabilization evidence is limited to package digest, current performance-only receipt, `cargo fmt --check`, full library tests, focused mandatory-law/independent-verification/scheduler/package-check/red-fixture/performance/final-packet/control-plane/namespace tests, and a raw line-cap scan. Coverage, Product/Fit/Journey, Rust/GC, standards-gardener, source audit, red report, final-packet, registry/app/install/cache, self-law, and update-goal receipts are stale or not rerun for this digest. Claim impact: source-local evidence only; current performance proof supports routine-usability/performance only and no final-packet correctness, transactional finalization green proof, CLI self-law green proof, update_goal eligibility, registry/reviewer exposure, readiness, release, completion claim, install/cache parity, or `update_goal()` call.

## `update_goal()` Is Forbidden Until All Are True

- [ ] Status: in_progress
- [ ] Current source audit passes.
  - Evidence: unchecked. Latest persisted source audit is stale and failing relative to live implementation digest `sha256:20f1637d41f593668d38620bb3452a258d30b1369d4a2c5a7f73a9d06153a756`; `validation_artifacts/ultragoal-audit/validator-receipt.json = sha256:dfb357500a198a5ac8e2e9db73352842233606438062bd971859f7a29cb2ec31` targets `sha256:1bf81589063cd172cf8a896594ccc2c75f53924b04dd90cb7c2596fb65cd42f5` and status `fail`. Claim impact: no current source-audit pass claim; readiness, release, completion, final-packet correctness, and `update_goal()` remain blocked.
- [ ] Current red fixture report passes with all fixtures failing for intended reasons.
  - Evidence: unchecked. Latest persisted red fixture report is stale and failing relative to live implementation digest `sha256:20f1637d41f593668d38620bb3452a258d30b1369d4a2c5a7f73a9d06153a756`; `validation_artifacts/ultragoal-audit/red-fixture-report.json = sha256:25e481ba43e59e2dc75140ef5bd3966acaeada8e2699d918f794f2f98ac8a769` targets `sha256:1bf81589063cd172cf8a896594ccc2c75f53924b04dd90cb7c2596fb65cd42f5` and status `fail`, so it is not current proof. Claim impact: no current red-fixture pass claim, no source-audit pass, readiness, release, completion, final-packet correctness, or `update_goal()` claim.
...
- [x] Plugin self-coverage is 100% with typed receipt and no uncovered records.
  - Evidence: `validation_artifacts/coverage/coverage-receipt.json = sha256:dffd49b4c0ffca8ad4eca5b9b0da2ec85fe54cd6beba5a26e2e697f539e19c54` targets live implementation digest `sha256:20f1637d41f593668d38620bb3452a258d30b1369d4a2c5a7f73a9d06153a756` and records `coverage.percent = 100`, `uncovered_records = []`, and `claim_ceiling = supports_complete_coverage_claim`. Claim impact: exact coverage only; no readiness/release/final-packet/registry/reviewer/completion or `update_goal()` claim.
...
- [x] Line-cap adherence is enforced. Evidence: `find validator/src -name '*.rs' -exec wc -l {} + | awk '$2 != "total" && $1 > 250 { print }'` emitted no rows, `cargo fmt --check` exited `0`, focused scheduler/package/red-fixture/command-dispatch tests passed, and full library tests passed 569/569 for current live implementation digest `sha256:20f1637d41f593668d38620bb3452a258d30b1369d4a2c5a7f73a9d06153a756`. Claim impact: source-local line-cap/source-topology evidence only; no readiness/release/completion/update_goal claim.
