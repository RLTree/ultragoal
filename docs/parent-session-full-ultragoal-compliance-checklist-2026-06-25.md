...
- [ ] Machine-readable observability fitting inventory tracks every law-bearing CLI command, validator check family, receipt/proof path, fixture/report path, and package surface as `fitted`, `partially_fitted`, or `unfitted`, and the validator fails every partial, unfitted, missing, stale, or row-shape-only fitting row.
  - Evidence: inventory added and validator-enforced, but not complete. `docs/generated/observability/command-inventory.json = sha256:fee5f1ead2e300d835242ce581170284c4d57d98072ee8479b2f3d6a85333292` declares 57/57 law-bearing command-family rows with explicit `fitting_status`, fitted surfaces, missing surfaces, validator check id, tests, receipt paths, query proof paths, and claim impact. Focused tests `cargo test --offline observability --lib --quiet` passed `12/12` and include green inventory, unfitted-row failure, and row-shape-only fitted-row failure.
  ...
  - Candidate digest: `sha256:d69d7f3858c657bf62bb1983c1fc6dc61ca357d87feb6d2d6c258f3214577f46`.
...
- [ ] Agent proof comes from CLI queries against VictoriaLogs, VictoriaMetrics, and VictoriaTraces; Grafana inspection is not claim authority.
  - Evidence: current `observe prove` fitting-inventory failure run `run-2350b5cd48e5ff87eb90b4fbadc6de6de07bd86815ca3745a5382ebdb8e654f0` was queried through CLI against VictoriaLogs, VictoriaMetrics, and VictoriaTraces for candidate `sha256:d69d7f3858c657bf62bb1983c1fc6dc61ca357d87feb6d2d6c258f3214577f46`; all three query commands exited `0`. This proves queryability for the current failure only, not full command-surface fitting.
  - Query commands: `target/debug/ultragoal --root . observe logs query --run-id run-2350b5cd48e5ff87eb90b4fbadc6de6de07bd86815ca3745a5382ebdb8e654f0 --limit 100`; `target/debug/ultragoal --root . observe metrics query --run-id run-2350b5cd48e5ff87eb90b4fbadc6de6de07bd86815ca3745a5382ebdb8e654f0 --limit 100`; `target/debug/ultragoal --root . observe traces query --run-id run-2350b5cd48e5ff87eb90b4fbadc6de6de07bd86815ca3745a5382ebdb8e654f0 --limit 100`.
  - Receipts: `validation_artifacts/observability/observe-logs-query.json = sha256:a5d7c3c661fa5671792ca30a8b9de68492fba95060e457cbf69d8c9cd4919b7e`; `validation_artifacts/observability/observe-metrics-query.json = sha256:c1bff29df62054eeb803a5dcf45fa7a61faca94bee3ba6a5357446ae426d6995`; `validation_artifacts/observability/observe-traces-query.json = sha256:dcc22227f2a36855005ba7644a39dac5c9bbf6ff1b215e2209add4579f358f21`.
  - Candidate digest: `sha256:d69d7f3858c657bf62bb1983c1fc6dc61ca357d87feb6d2d6c258f3214577f46`.
...
- [ ] Required query proof covers failed run by run_id, failed law by law_id, failed check by check_id, blocked claim by claim_id, command duration metrics, stale receipt counters, full command trace, and current proof-graph failure across logs, metrics, and traces.
  ...
  - Query results: current run `run-2350b5cd48e5ff87eb90b4fbadc6de6de07bd86815ca3745a5382ebdb8e654f0` returns rows in `observe-logs-query.json`, `observe-metrics-query.json`, and `observe-traces-query.json`.
  - Receipt: `validation_artifacts/observability/observe-explain-failure.json = sha256:029ec34ab0747f7b56e5394b1313709ad63f0f84d7a0d25a0833aa12769a86a1`.
  - Candidate digest: `sha256:d69d7f3858c657bf62bb1983c1fc6dc61ca357d87feb6d2d6c258f3214577f46`.
...
- [ ] Stack health proves VictoriaLogs, VictoriaMetrics, VictoriaTraces, OpenTelemetry Collector, Vector, and Grafana are running and healthy.
  - Evidence: current source-local Gate 92 health receipt targets package digest `sha256:d69d7f3858c657bf62bb1983c1fc6dc61ca357d87feb6d2d6c258f3214577f46`.
  - Command: `target/debug/ultragoal --root . observe stack health` exited `0`.
  - Receipt: `validation_artifacts/observability/observe-stack-health.json = sha256:3115688dfad410d4b21b6ca1dd73666cfd7b1e25af85089a8d62f848b8b88207`.
  - Candidate digest: `sha256:d69d7f3858c657bf62bb1983c1fc6dc61ca357d87feb6d2d6c258f3214577f46`.
...
- [ ] Stack smoke proves log ingestion/query, metric ingestion/query, trace ingestion/query, and one correlated ultragoal CLI run visible in all three stores.
  - Evidence: current source-local Gate 92 smoke receipt targets package digest `sha256:d69d7f3858c657bf62bb1983c1fc6dc61ca357d87feb6d2d6c258f3214577f46`.
  ...
  - Receipt: `validation_artifacts/observability/observe-stack-smoke.json = sha256:108c73127d18006a7fd8f0b9402fb6fb610d91c7cafb504288f8ea7f2b9a4ad7`.
  - Candidate digest: `sha256:d69d7f3858c657bf62bb1983c1fc6dc61ca357d87feb6d2d6c258f3214577f46`.
