...
- [ ] Current source audit passes.
  - Evidence: unchecked. Latest persisted source audit is stale relative to live implementation digest `sha256:e2e422756f4404c5e0d3f363d1172c4ee5aba891cd1aff2a02d6c8fb4a9abd41`; `validation_artifacts/ultragoal-audit/validator-receipt.json` targets `sha256:1bf81589063cd172cf8a896594ccc2c75f53924b04dd90cb7c2596fb65cd42f5` and status `fail`. Claim impact: no current source-audit pass claim; readiness, release, completion, final-packet correctness, and `update_goal()` remain blocked.
- [ ] Current red fixture report passes with all fixtures failing for intended reasons.
  - Evidence: unchecked. Latest persisted red fixture report is stale relative to live implementation digest `sha256:e2e422756f4404c5e0d3f363d1172c4ee5aba891cd1aff2a02d6c8fb4a9abd41`; `validation_artifacts/ultragoal-audit/red-fixture-report.json` targets `sha256:1bf81589063cd172cf8a896594ccc2c75f53924b04dd90cb7c2596fb65cd42f5` and status `fail`, so it is not current proof. Claim impact: no current red-fixture pass claim, no source-audit pass, readiness, release, completion, final-packet correctness, or `update_goal()` claim.
...
- [ ] Plugin self-coverage is 100% with typed receipt and no uncovered records.
  - Evidence: unchecked. Latest persisted coverage receipt targets `sha256:84c0e8f27dabfa79804b516d9606670ba235b9d994b5636f53f230d21be08add`, not live implementation digest `sha256:e2e422756f4404c5e0d3f363d1172c4ee5aba891cd1aff2a02d6c8fb4a9abd41`. Exact coverage must be rerun before this row can support a current claim. Claim impact: no current exact-coverage claim, no readiness/release/final-packet/registry/reviewer/completion or `update_goal()` claim.
...
- [x] Line-cap adherence is enforced. Evidence: `find validator/src -name '*.rs' -exec wc -l {} + | awk '$2 != "total" && $1 > 250 { print }'` emitted no rows, `cargo fmt --check` exited `0`, focused namespace test `cargo test --offline namespace_source_topology_is_selective_about_prefixes_and_generic_leaves --lib --quiet` passed 1/1, and full library tests passed 569/569 for current live implementation digest `sha256:e2e422756f4404c5e0d3f363d1172c4ee5aba891cd1aff2a02d6c8fb4a9abd41`. Claim impact: source-local line-cap/source-topology evidence only; no readiness/release/completion/update_goal claim.
