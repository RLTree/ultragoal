...
- [ ] Run full source audit with receipt and red fixture report. Evidence: Status: in progress; red fixture report validated current, source audit still failing on pre-existing stale-evidence classes.
