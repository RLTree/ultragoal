...
| --- | --- | --- | --- | --- |
| N06 routine execution | under_review | `a20709a93` / tree `3345eb2c` | Clean proof freeze enforces a monotonic contender deadline with kill/reap and an executable blocking red control; WorkerResult and higher claims remain withheld | Independently falsify the exact proof and resume cumulative source review |
...
required exact-tree review of `a20709a93` / tree `3345eb2c`; receipt regeneration
