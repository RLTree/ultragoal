...
| --- | --- | --- | --- | --- |
| N06 routine execution | under_review | `6f097aae5` / tree `89a0bdc6` | Clean source freeze uses nonblocking typed busy refusal before issuer or effect authority; WorkerResult remains byte-untouched and higher claims are withheld | Independently falsify held-lock zero-effect refusal and post-release real public retry on the exact cumulative tree |
...
required exact-tree review of `6f097aae5` / tree `89a0bdc6`; receipt regeneration
