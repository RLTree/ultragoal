...
| --- | --- | --- | --- | --- |
| N06 routine execution | rework | `4ec9a8fde` / tree `92bdabf6` | Exact-tree review found the panic control accepts any supervisor failure without proving the exact product child was live in the owned group; receipt and integration remain withheld | Bind an exact live-child handshake and panic sentinel to product binary identity, liveness, group membership, and parent validation |
...
exact live-child handshake invariant across spawn, binary identity, liveness,
group membership, stop observation, intended panic, and parent containment.
