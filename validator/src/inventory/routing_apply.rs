...
use crate::inventory::compatibility::{
    RETAINED_KIND, apply_agent_route, apply_route, retention_candidates,
};
            ...
            .filter(|entry| entry.authority_state == AuthorityState::Legacy)
        {
            ...
            match matches.as_slice() {
                ...
                [route] => {
                    ...
                    let agent_verified = apply_agent_route(
                        entry,
                        &route.route_id,
                        route.matcher.exact_stable_id(),
                        &route.canonical_target,
                        ...
                        &route.transition,
                        targets.get(&route.canonical_target),
                        self.reader_proof_is_current,
