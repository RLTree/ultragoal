    ...
    for group in compiled {
        entries.push(InventoryEntry {
            ...
            input_provenance: vec![
                ...
                "validator/src/cli/successor/command_contract/mod.rs".to_owned(),
                "validator/src/cli/successor/command_contract/arguments.rs".to_owned(),
                "validator/src/cli/successor/command_contract/commands.rs".to_owned(),
                "validator/src/cli/successor/command_contract/descriptor.rs".to_owned(),
                "validator/src/cli/successor/command_contract/exit.rs".to_owned(),
                "validator/src/cli/successor/command_contract/invocation.rs".to_owned(),
            ],
            references: vec![
