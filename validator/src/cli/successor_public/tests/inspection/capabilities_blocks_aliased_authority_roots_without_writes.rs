...
#[test]
pub(crate) fn capabilities_verify_distinct_authority_roots_without_writes() {
...
#[test]
pub(crate) fn capabilities_block_aliased_authority_roots_without_writes() {
...
#[test]
pub(crate) fn capabilities_withhold_authority_without_package_root() {
...
#[test]
pub(crate) fn capabilities_withhold_host_authority_when_home_is_absent() {
...
#[test]
pub(crate) fn capabilities_catalog_exposes_a_typed_package_root() {
...
#[cfg(unix)]
#[test]
pub(crate) fn capabilities_reject_forged_host_paths_without_authority_io() {
