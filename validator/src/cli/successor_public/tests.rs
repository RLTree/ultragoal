...
#[test]
fn fit_apply_fails_closed_without_preprovisioned_host_authority() {
...
#[test]
fn fit_apply_runs_the_public_production_route_and_retires_recovery_state() {
...
#[cfg(target_vendor = "apple")]
#[test]
fn fit_apply_services_pending_recovery_before_a_conflicting_plan_can_block_it() {
    use std::os::unix::fs::PermissionsExt;
