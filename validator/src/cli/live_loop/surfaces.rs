...
pub(crate) const LOOP_VALIDATION_SURFACES: &[LoopValidationSurface] = &[
    ...
    surface(
        ...
        "bash scripts/check-coverage-full /Users/terrynoblin/Projects/harness-ultragoal-plugin-proposal",
        "requires_command_telemetry_roundtrip",
    ),
    surface(
    ...
    surface(
        ...
        "bash scripts/check-coverage-fast /Users/terrynoblin/Projects/harness-ultragoal-plugin-proposal",
        "bash scripts/check-coverage-fast /Users/terrynoblin/Projects/harness-ultragoal-plugin-proposal",
        "requires_command_telemetry_roundtrip",
    ),
    surface(
