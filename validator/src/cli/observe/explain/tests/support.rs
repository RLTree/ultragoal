    ...
    fs::write(
        ...
        format!(
            ...
            json!({
                ...
                "query_hint_promql": "sum by (operation,status,check_id,claim_id,surface,failure_class,exporter) (max_over_time(ultragoal_command_total{operation=\"observe.prove\"}[5m]))",
