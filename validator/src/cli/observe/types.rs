...
impl ObserveOperation {
    pub(crate) fn id(self) -> &'static str {
        match self {
            ...
            Self::CommandRoundtrip => "observe.command-roundtrip",
            Self::ExplainNext => "observe.explain.next",
    ...
    pub(crate) fn subcommand(self) -> &'static str {
        match self {
            ...
            Self::Prove => "prove",
            Self::CommandRoundtrip => "command-roundtrip",
            Self::ExplainNext => "explain",
...
pub(crate) struct ObserveCommand {
    ...
    pub(crate) target_command: Option<String>,
