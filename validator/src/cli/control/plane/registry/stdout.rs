...
fn summary(path: &Path, value: &Value) -> String {
    format!(
        "ultragoal-registry-probe {} proven={} operation={} candidate={} receipt={} registry_receipt={} run_id={} correlation_id={} claim_impact={} supported_claims={} unsupported_claims={}",
        text(value, "status"),
        proven(value),
        text(value, "operation"),
        text(value, "candidate_digest"),
        receipt_path(path, value),
        super::ACTIVE_RECEIPT,
        text(value, "run_id"),
