...
pub(super) fn contract(value: &Value) -> Vec<String> {
    ...
    let mut lines = vec![format!(
        "ultragoal-namespace-check {status} operation={} candidate={} receipt={receipt} run_id={run_id} correlation_id={correlation_id} claim_impact={claim_impact} supported_claims={} unsupported_claims={}",
