...
#[test]
fn value_failures_cover_all_decision_shapes() {
    assert!(contains(
...
#[test]
fn claim_ceiling_is_required_for_valid_decisions() {
...
#[test]
fn fixture_reader_and_ceiling_shape_fail_closed() {
    let root =
...
#[test]
fn review_round_signoff_and_valid_fixture_reader_fail_closed() {
