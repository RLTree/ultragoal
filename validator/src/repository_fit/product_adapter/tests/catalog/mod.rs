...
#[path = "production/generate_erases_preexisting_outputs_before_manifest_validation.rs"]
mod production_generate_erases_preexisting_outputs_before_manifest_validation;
#[path = "production/generate_reports_cleanup_failure_before_validation.rs"]
mod production_generate_reports_cleanup_failure_before_validation;
#[path = "production/source_classifier_rejects_real_links_fifo_socket_and_directory_without_hanging.rs"]
