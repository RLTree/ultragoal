...
use ultragoal::distribution::{
    ...
    HostCapabilityDeclaration, InstallPlan, InstallScope, InstallTransaction, JourneyBinding,
    MarketplaceScope, PackageEffects, PackageIdentity, PackagePlan, PackageSnapshot,
    InstalledPackageRuntimeProbeRequest, RuntimeProbePlan, ScopedFile, ScopedInstall,
    SurfaceIdentity, build_package, install,
