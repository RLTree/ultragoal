...
#[path = "distribution_contract/descriptor/cas.rs"]
mod descriptor_cas;
#[path = "distribution_contract/descriptor_races/mod.rs"]
mod descriptor_races;
#[path = "distribution_contract/descriptor/recovery.rs"]
mod descriptor_recovery;
#[path = "distribution_contract/descriptor/unlink.rs"]
...
mod identity_ladder;
#[path = "distribution_contract/install/mod.rs"]
mod install;
#[path = "distribution_contract/isolated_journey.rs"]
mod isolated_journey;
#[path = "distribution_contract/journey_adversarial/mod.rs"]
...
#[path = "distribution_contract/package/mod.rs"]
mod package;
#[path = "distribution_contract/package_identity/mod.rs"]
mod package_identity;
#[path = "distribution_contract/package_journey_fixture.rs"]
mod package_journey_fixture;
#[path = "distribution_contract/package_manifest/mod.rs"]
mod package_manifest;
#[path = "distribution_contract/package_output/mod.rs"]
mod package_output;
#[path = "distribution_contract/positive.rs"]
mod positive;
#[path = "distribution_contract/prefix_collisions.rs"]
mod prefix_collisions;
#[path = "distribution_contract/runtime_session/mod.rs"]
mod runtime_session;
