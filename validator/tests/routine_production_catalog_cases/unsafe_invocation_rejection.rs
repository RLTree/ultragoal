...
pub(crate) fn execution_authority_fields_paths_and_prose_substitution_fail_closed() {
    crate::catalog_fixture_invocation::run_catalog_case("unsafe-invocation", |invocation| {
        for (field, value) in [
...
pub(crate) fn retired_v1_catalog_has_no_behavioral_reader() {
    crate::catalog_fixture_invocation::run_catalog_case("retired-v1", |invocation| {
...
pub(crate) fn symbolic_tool_executable_content_mode_and_identity_substitutions_are_refused() {
    crate::catalog_fixture_invocation::run_catalog_case("runner-substitution", |invocation| {
