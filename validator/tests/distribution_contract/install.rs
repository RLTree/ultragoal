use crate::distribution::{
    ...
    InstallScope as Scope, PackageEffects, ScopedInstall, assert_test_effect_hook_consumed,
    build_package, install, plan_package, rollback_install, set_test_effect_hook_matching,
    uninstall,
};
